    ...
    return (
        <div>
            ...
            {loading ? (
                ...
                claims.map(claim => (
                    <div key={claim._id} className="card p-0 overflow-hidden mb-lg shadow-sm border-none" style={{ borderRadius: '20px' }}>
                        <div className="p-xl grid grid-2 gap-xl" style={{ gridTemplateColumns: '1fr 340px' }}>
                            {/* Left: Claim Header */}
                            <div>
                            ...
                            {/* Right: Quick Actions */}
                            <div className="flex flex-col gap-md justify-center border-l border-gray-100 pl-xl">
                                <button
                        ...
                        {expanded === claim._id && (
                            <div style={{ marginTop: 16, borderTop: '1px solid #e2e8f0', paddingTop: 16 }}>
                                ...
                                {claim.icdCodes?.length > 0 && (
                                    <div style={{ marginBottom: 10 }}>
                                        ...
                                        {claim.icdCodes.map((c, i) => (
                                            <span key={i} style={{ display: 'inline-block', background: '#eff6ff', border: '1px solid #93c5fd', color: '#1e40af', borderRadius: 6, padding: '3px 10px', margin: '3px', fontSize: 12, fontWeight: 600 }}>
                                ...
                                {claim.cptCodes?.length > 0 && (
                                    <div style={{ marginBottom: 10 }}>
                                        <p style={{ fontWeight: 600, fontSize: 13, color: '#1e293b', margin: '0 0 6px' }}>CPT Codes:</p>
                                        {claim.cptCodes.map((c, i) => (
                                            <span key={i} style={{ display: 'inline-block', background: '#f0fdf4', border: '1px solid #86efac', color: '#15803d', borderRadius: 6, padding: '3px 10px', margin: '3px', fontSize: 12, fontWeight: 600 }}>
                                                {c.code} — {c.description}
                                            </span>
                                        ))}
                                    </div>
