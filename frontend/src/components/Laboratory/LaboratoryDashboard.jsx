                        ...
                        <table className="medical-ledger-table">
                            ...
                            <tbody>
                                {tests.map((test) => {
                                    ...
                                    const hasResolvedDispute = test.reportDispute?.status === 'resolved';
                                                ...
                                                <div className="flex flex-col gap-1">
                                                    {test.reportPDF ? (
                                                        <>
                                                            ...
                                                            {hasOpenDispute && (
                                                                <button
                                                                    className="m-badge m-badge-red text-[9px] cursor-pointer hover:scale-105 transition-transform"
                                                                    onClick={() => setDisputeModalTest(test)}
                                                                >
                                                                    ⚠️ DISPUTE RAISED
                                                                </button>
                                                            )}
                                                            {hasResolvedDispute && (
                                                                <button
                                                                    className="m-badge m-badge-green text-[9px] cursor-pointer"
                                                                    onClick={() => setDisputeModalTest(test)}
                                                                >
                                                                    ✅ RESOLVED
                                                                </button>
